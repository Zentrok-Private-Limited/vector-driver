...
export default function PrinterSetupPage() {
  ...
  return (
    <div className="min-h-screen bg-white antialiased text-[#333333] font-subheading font-normal text-[15px]">
      ...
      {/* 1. MAIN GLOBAL PLUG-IN HEADER (Active Menu Tab: Printer Support) */}
      <Header />
            ...
            <div className="space-y-2">
              ...
              <div className="relative max-w-xl">
                <input
                  ...
                  className="w-full bg-white border border-gray-400 rounded-lg outline-sky-600 pl-5 pr-12 h-11 text-[16px] text-black tracking-wide focus:outline-none focus:border-[#007DBD] shadow-inner"
                />
                <button 
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-4 gap-x-12 text-[14px]">
          ...
          <div className="space-y-3.5">
            <button onClick={() => handlePopularClick("HP DeskJet 2300 All-in-One Printer series")} className="text-[#006699] hover:underline font-medium block text-left">
              HP DeskJet 2300 All-in-One Printer series
            </button>
            <button onClick={() => handlePopularClick("HP LaserJet 1018 Printer")} className="text-[#006699] hover:underline font-medium block text-left">
              HP LaserJet 1018 Printer
            </button>
            <button onClick={() => handlePopularClick("HP LaserJet P1008 Printer")} className="text-[#006699] hover:underline font-medium block text-left">
          ...
          {/* Column Group 2 */}
          <div className="space-y-3.5">
            <button onClick={() => handlePopularClick("HP DeskJet GT 5820 All-in-One Printer series")} className="text-[#006699] hover:underline font-medium block text-left">
              HP DeskJet GT 5820 All-in-One Printer series
            </button>
            <button onClick={() => handlePopularClick("HP LaserJet P1007 Printer")} className="text-[#006699] hover:underline font-medium block text-left">
              HP LaserJet P1007 Printer
            </button>
            <button onClick={() => handlePopularClick("HP LaserJet Pro M202 series")} className="text-[#006699] hover:underline font-medium block text-left">
          ...
          {/* Column Group 3 */}
          <div className="space-y-3.5">
            <button onClick={() => handlePopularClick("HP Ink Tank 310 series")} className="text-[#006699] hover:underline font-medium block text-left">
              HP Ink Tank 310 series
            </button>
            <button onClick={() => handlePopularClick("HP Laser 100 Printer series")} className="text-[#006699] hover:underline font-medium block text-left">
              HP Laser 100 Printer series
            </button>
            <button onClick={() => handlePopularClick("HP Laser MFP 1000 Printer series")} className="text-[#006699] hover:underline font-medium block text-left">
